...
HOST = "mrwzi"
ROWS = [
    ("Now",        "Building AI systems for crypto trading and exchange tools"),
    ("Prev",       "Business websites, secure apps, encrypted chat, DCA investing tools"),
    ("Stack",      "Python · JavaScript · HTML · CSS · Blockchain · Crypto Networks · AI Agents"),
    ("Highlights", "Full-stack development · UI design · Blockchain · Local AI training"),
    ("Learning",   "Deepening my understanding of AI, prompting, and agent workflows"),
    ("Reach",      "@mrwzi · wzitrade.com · accdivide.com"),
]
# ------------------------------------------------------------------------------
